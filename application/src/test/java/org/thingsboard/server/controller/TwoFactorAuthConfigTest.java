...
public class TwoFactorAuthConfigTest extends AbstractControllerTest {
    ...
    public void testSubmitTotpTwoFaAccountConfig_validationError() throws Exception {
        ...
        totpTwoFaAccountConfig.setAuthUrl("otpauth://totp/ThingsBoard%20(Tenant):tenant@nexarise.ai?issuer=ThingsBoard+%28Tenant%29&secret=FUNBIM3CXFNNGQR6ZIPVWHP65PPFWDII");
